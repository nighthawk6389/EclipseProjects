...
public class GetMediaHelper {
    ...
    public static Map<String,List> getMediaList(String restOfURL){
    	...
    	try{
			...
			holder.put("message", new ArrayList());
			...
			while(s.hasNext()){
	            ...
	            if( next.equalsIgnoreCase("message") || next.equalsIgnoreCase("message:")){			
					currentType = MESSAGE;
					continue;
				}
    		...
    		Log.d("GetMediaHelper","Temp: "+ temp+ " "+t.toString());
    		return null;
    	}
   ...
   public static String getDateFromFileTitle(String restOfURL) {
	...
	private static void putCorrectFieldsIntoArrays(Map<String,List> holder, 
		...
		if(currentType == MESSAGE){
			...
			holder.get(MESSAGE).add(summary);
			return;
		}
